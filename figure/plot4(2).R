...
##png("c:/dung/datascience/Explanatoryanalysis/Plot4.png", width = 3, height = 4, units = 'in')
png("c:/dung/datascience/Explanatoryanalysis/Plot4.png",width = 480, height = 480,units = "px", pointsize = 12, bg = "white", res = NA,restoreConsole = TRUE)
par (mfrow = c(2,2))
